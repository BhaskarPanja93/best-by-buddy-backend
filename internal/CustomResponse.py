...
class CustomResponse:
    ...
    def createDataDict(self):
        return {"STATUS_CODE": self.statusCode, "STATUS_DESC": self.statusDesc, "DATA": self.data}
    ...
    def readValues(self, statusCode:int, statusDesc:str, data, cookieDict:dict|None=None):
